$(function(){
    ...
    function undial(){
		$(".left .condition *[name='info']").attr("checked",false);
		$(".left .condition *[name='info']").click(function(){
			$(this).attr("checked",false);
		});
		$(".left .condition *[name='global']").attr("checked",false);
		$(".left .condition *[name='global']").click(function(){
			$(this).attr("checked",false);
		});
		$(".left .condition *[name='organization']").attr("checked",false);
		$(".left .condition *[name='organization']").click(function(){
			$(this).attr("checked",false); 
		});
		$(".left .condition *[name='study']").attr("checked",false);
		$(".left .condition *[name='study']").click(function(){
			$(this).attr("checked",false);
		});
		$(".left .condition *[name='daily']").attr("checked",false);
		$(".left .condition *[name='daily']").click(function(){
			$(this).attr("checked",false);
		});
		$(".left .condition *[name='proSet']").attr("checked",false);
		$(".left .condition *[name='proSet']").click(function(){
			$(this).attr("checked",false);
		});
		$(".left .condition *[name='cycle']").attr("checked",false);
		$(".left .condition *[name='cycle']").click(function(){
			$(this).attr("checked",false);
		});
		
		$(".left .condition *[name='change']").keyup(function(){
			var val=$(this).val().length;
			if(val>0){
				$(this).val($(this).val().substring(0,0));
			}
		});
		$(".left .condition *[name='job']").attr("checked",false);
	...
	function dial(){
		$(".left .condition *[name='info']").unbind("click");
		$(".left .condition *[name='info']").click(function(){
		...
		$(".left .condition *[name='global']").unbind("click");
		$(".left .condition *[name='global']").click(function(){
			if($(this).attr("checked")!=false)
	        {  
	            $(this).siblings().attr("checked",false);  
		...
		$(".left .condition *[name='organization']").unbind("click");
		$(".left .condition *[name='organization']").click(function(){
			if($(this).attr("checked")!=false)
	        {  
	            $(this).siblings().attr("checked",false);  
		...
		$(".left .condition *[name='study']").unbind("click");
		$(".left .condition *[name='study']").click(function(){
			if($(this).attr("checked")!=false)
	        {  
	            $(this).siblings().attr("checked",false);  
		...
		$(".left .condition *[name='daily']").unbind("click");
		$(".left .condition *[name='daily']").click(function(){
			if($(this).attr("checked")!=false)
	        {  
	            $(this).siblings().attr("checked",false);  
		...
		$(".left .condition *[name='proSet']").unbind("click");
		$(".left .condition *[name='proSet']").click(function(){
			if($(this).attr("checked")!=false)
	        {  
	            $(this).siblings().attr("checked",false);  
		...
		$(".left .condition *[name='cycle']").unbind("click");
		$(".left .condition *[name='cycle']").click(function(){
			if($(this).attr("checked")!=false)
	        {  
	            $(this).siblings().attr("checked",false);  
		...
		$(".left .condition *[name='change']").unbind("keyup");
		
		$(".left .condition *[name='job']").unbind("click");
		$(".left .condition *[name='job']").click(function(){
			if($(this).attr("checked")!=false)
	        {  
	            $(this).siblings().attr("checked",false);  
			...
			if(job == "否"){
				...
				$(".left .condition *[name='text']").unbind("keyup");
				$(".left .condition *[name='text']").keyup(function(){
					var val=$(this).val().length;
					if(val>0){
	...
	$("#save").click(function(){
		...
		if(button == "已挂断"){
			...
			$(window.parent.document).find("body").animate({scrollTop:0},5);
			toastr.warning("未拨通电话，请先拨打电话");
		}
		else if(button == "|| 挂断"){
			$(window.parent.document).find("body").animate({scrollTop:0},5);
			toastr.warning("请先挂断电话");
		}
		else{
