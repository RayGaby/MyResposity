...
public class UserController extends Controller implements I_UserController {
	...
	public void login() {
		...
		if (bool) {
			...
			if (subject.isAuthenticated()) {
				...
				Boolean block=record.getBoolean("block");
	...
	@Override
	public void searchUserInfoAtMyHomepage() {
		String username = getSessionAttr("username");
		Record record = i_UserService.searchUserInfoAtMyHomepage(username);
